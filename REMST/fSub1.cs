...
namespace REMST
{
    public partial class fSub1 : Form
    {
        ...
        private int mnStatusCol, mnStatusRow;
        private bool mbFirst;
        private int nNumber;

        private bool fValid(int nCol1,int nRow1,int nCol2,int nRow2)
        {
            bool bValid = true;
        ...
        private void fClick(int nCol, int nRow)
        {
            ...
            {
                bValid = fValid(mnStatusCol, mnStatusRow, nCol, nRow);
                if (!bValid)
                {
